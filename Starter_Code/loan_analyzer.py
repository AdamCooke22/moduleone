...
def calculate_present_value(loan_price, remaining_months, future_value,):
...
new_loan_present_value = calculate_present_value(new_loan["loan_price"], new_loan["remaining_months"], new_loan["future_value"])
